    ...
    <div class="container-fluid darkBanner py-5 ">
        ...
        <div class="row form-container justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                ...
                <form action="{{ route('comic.update', $cardComics->id) }}" method="POST">
                    @csrf()
                    @method('put')
                    ...
                    <div class="my-3 mb-3">
                        ...
                        <input name="title" type="text" class="form-control" value="{{old('title', $cardComics->title)}}" >
                        <div class="form-text">Inserisci il titolo</div>
                    </div>
                    <div class="mb-3">
                        <label for="description" class="form-label fw-bold">Descrizione</label>
                        <input name="description" type="text" class="form-control" value="{{old('description', $cardComics->description)}}">
                        <div class="form-text">Inserisci la descrizione</div>
                    </div>
                    <div class="mb-3">
                        <label for="thumb" class="form-label fw-bold">Immagine di copertina</label>
                        <input name="thumb" type="text" class="form-control" value="{{old('thumb', $cardComics->thumb)}}">
                        <div class="form-text">Inserisci l'url dell'immagine</div>
                    </div>
                    <div class="mb-3">
                        <label for="price" class="form-label fw-bold">Prezzo</label>
                        <input name="price" type="decimal" class="form-control" value="{{old('price', $cardComics->price)}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="series" type="string" class="form-control" value="{{old('series', $cardComics-> series)}}">
                        <div class="form-text">Inserisci la serie del fumetto</div>
                    </div>
                    <div class="mb-3">
                        <label for="sale_date" class="form-label fw-bold">Data uscita</label>
                        <input name="sale_date" type="date" class="form-control" value="{{old('sale_date', $cardComics->sale_date )}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="type" type="text" class="form-control" value="{{old('type', $cardComics->type )}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="artists" type="text" class="form-control" value="{{old('artists', implode(", ",$cardComics->artists))}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="writers" type="text" class="form-control" value="{{old('writers', implode(", ",$cardComics->writers) )}}">
